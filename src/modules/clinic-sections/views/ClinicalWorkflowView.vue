...
const labResultInterpretationValue = computed<string>({
  get: () => labResultForm.value.interpretation || 'none',
  set: (value) => { labResultForm.value.interpretation = (value === 'none' ? '' : value) as LabResult['interpretation'] },
})
